...
Data quality checks address nulls, errors, and ensure precision. 

For detailed architecture, pipeline flow, data quality checks, and deeper insights, please refer to the comprehensive documentation in /doc/ecomm_proj.docx.

**Tech stack used - Databricks and Azure**
